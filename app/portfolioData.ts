    ...
    items: [
      {
        ...
        summary:
          "Conducted hands-on VAPT, SOC monitoring, incident investigation, vulnerability validation, and security hardening activities in authorized lab environments using Burp Suite Professional, Wireshark, Nmap, and security benchmark guidance.",
        workflow: [
          "Conducted 20+ Vulnerability Assessment & Penetration Testing (VAPT) engagements using Burp Suite Professional",
          "Identified and validated OWASP Top 10 vulnerabilities including SQL Injection (SQLi), Cross-Site Scripting (XSS), authentication weaknesses, and security misconfigurations",
          "Performed security event analysis, incident investigation, vulnerability validation, threat identification, and security troubleshooting",
          "Conducted log analysis, network traffic analysis, and security event investigation to identify indicators of compromise, attack patterns, and security weaknesses",
          "Assisted in vulnerability management including vulnerability identification, risk classification, remediation tracking, root cause analysis, and technical reporting",
        ],
        focusTitle: "🛠 Tools & Security Areas",
        focusItems: [
          "Burp Suite Professional, Wireshark, Nmap",
          ...
          "Operating system hardening, network hardening, and security controls",
        ],
        impact: [
          "Produced 15+ technical security assessment reports with risk ratings and remediation recommendations",
          "Recommended security control enhancements and operational improvement measures",
          "Improved understanding of vulnerability management, incident response, and attack surface reduction",
        ],
      },
      {
        company: "IBM",

...
export default function Portfolio() {
  ...
  return (
    <main className="relative min-h-screen overflow-x-hidden text-slate-200 scroll-smooth">
      <CyberScene />
      <div className="site-depth-overlay" />

      <header className="sticky top-0 z-50 border-b border-cyan-200/10 bg-[rgba(2,7,11,0.62)] backdrop-blur-2xl">
      ...
      <section className="relative wide-frame min-h-[calc(100svh-74px)] px-6 pt-12 pb-20 md:pt-18 md:pb-24">
        ...
        <div className="relative overflow-hidden px-0 py-6 md:py-10 xl:py-12">
          ...
          <div className="relative z-10 hero-grid min-h-[72svh] items-center">
            <div className="reveal hud-panel relative p-6 md:p-8 xl:p-10">
            ...
            <div className="reveal relative xl:pl-10">
              <div className="relative">
                <div className="profile-module angled-card p-5 md:p-6 xl:p-7">
                  <div className="mb-6">
      ...
      <section id="contact" className="scroll-mt-24 wide-frame px-6 py-16 md:py-18 relative">
        <div className="relative z-10 px-0 py-6 md:py-7 xl:py-8">
